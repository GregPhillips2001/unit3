...
text = TextAsset("SATURDAYS", fill=white, style="bold 5pt Times")
text2 = TextAsset("ARE_FOR", fill=blue, style="bold 5pt Times")
text3 = TextAsset("THE_BOYS", fill=white, style="bold 5pt Times")
